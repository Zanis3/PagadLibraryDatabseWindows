...
{
    public partial class UCUserBorrowBook : UserControl
    {
        private UCUserBorrowBookExtension viewBookDetails;
        public UCUserBorrowBook()
        {
            InitializeComponent();
        ...
        private void tblViewBooks_CellClick(object sender, DataGridViewCellEventArgs e)
        {
            if (e.RowIndex >= 0 && e.ColumnIndex >= 0)
            {
                ...
                {
                    viewBookDetails = new UCUserBorrowBookExtension(bookID);
